  ...
  const handleSearch = (value) => {
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        /* Search anywhere without strict bbox restrictions */
        const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(value)}.json?access_token=${token}&limit=8&language=id,en`;
