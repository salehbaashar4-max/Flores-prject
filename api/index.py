...
# FastAPI startup events are tied to the ASGI lifespan protocol, which Vercel's
# Python runtime does not run. Earth Engine is initialized here instead, at
# cold start, so the NDVI / moisture / elevation layers serve live tiles
# rather than silently falling back to the static polygons.
